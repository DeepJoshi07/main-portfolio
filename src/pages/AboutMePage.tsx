    ...
    <div className="bg-black text-white font-mono">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="prose prose-invert prose-lg max-w-none space-y-6 text-gray-300">
          <p>
            Hello, I’m Deep Joshi. I’m a MERN-stack developer with a relentless focus on precision, performance, and user experience. I don’t just write code — I engineer systems that are fast, maintainable, and purpose-built.
          </p>
          <p>
            I’m a self-taught full-stack developer. My specialty is building interactive, high-performance web applications that merge clean design with robust functionality.
          </p>
          <p>
