      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="px-3 py-1 border border-gray-800 rounded bg-black/50">
            <span className="text-white font-mono text-sm">Deep Joshi</span>
          </div>
          <div className="hidden sm:block text-xs text-gray-400 font-mono">Backend Devloper · MEARN-stack</div>
        </div>
