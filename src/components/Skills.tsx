...
const skillsData = {
  ...
  Frontend: ['React', 'Tailwind CSS', 'Next.js','Ejs'],
  Backend: ['Node.js', 'Express.js','Docker','Redux','Nginx','Micro Servises'],
  Databases: ['MongoDB', 'MySQL','Redis','Postgre'],
  Tools: ['Git', 'GitHub', 'VSCode', 'Postman'],
  Other: ['REST APIs','Graph Ql', 'WebSockets', 'AI API Integration'],
};
